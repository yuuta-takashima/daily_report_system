...
public class FrontController extends HttpServlet {
    ...
    /**
     *  @see HttpServlet#doget(HttpServletRequest request, HttpServretResponse response)
     */
    ...
    private ActionBase getAction(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            // 該当するActionオブジェクトを作成(例：リクエストからパラメータaction=Employee の場合、action.EmployeeActionオブジェクト)
